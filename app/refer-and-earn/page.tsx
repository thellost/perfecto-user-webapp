...
function referAndEarn() {
    ...
    return (
        <div className="min-h-screen overflow-x-hidden bg-gray-50">
            ...
            <div className="bg-white min-h-screen flex items-center py-8 sm:py-0">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                        {/* Left Section: Images */}
                        <div className="relative grid grid-cols-2 gap-4 sm:gap-6">
                            <div className="relative -translate-y-8 sm:-translate-y-20">
                                <img
                                    className="object-cover aspect-[3/4] w-full rounded-lg shadow-lg"
                        ...
                        <div className="mt-8 lg:mt-0">
                            <h4 className="text-gray-500 font-bold pb-2 text-base sm:text-lg">
                                PerfectoHome Referral Program
                            </h4>
                            <h2 className="text-xl sm:text-2xl md:text-3xl text-gray-900  text-left">
                                Cheaper mortgages for your friend, and 10% commission for you.
                            </h2>
                            <p className="mt-4 text-base sm:text-lg text-black text-justify">
                            ...
                            {loading ? (
                                ...
                                <div className="mt-4">
                                    ...
                                    <div className="mt-2 flex flex-col sm:flex-row rounded-md shadow-sm">
                                        <input
                                            type="text"
                                            id="referralLink"
                                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-t-md sm:rounded-tl-md sm:rounded-bl-md focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                        ...
                                        />
                                        <button
                                            className="mt-2 sm:mt-0 sm:ml-2 inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md sm:rounded-r-md text-white bg-primaryOrange hover:bg-primaryOrangeHover focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primaryOrange"
                                            onClick={() => {
                                                navigator.clipboard
                                                    .writeText(
                                                        `${process.env.NEXT_PUBLIC_REACT_APP_API_URL}/signup/?referral_code=${referral_code}`
                                                    )
                                                    .then(() => {
                                    ...
                                    <div className="mt-4 text-sm text-gray-600">
                                        ...
                                        <Link href="/" className="text-blue-600">
                                            Perfecto Home Referral Term
                                        </Link>
                                    </div>
                                </div>
                            ) : (
                                <div className="pt-5 text-sm text-gray-600">
                                    You need to log in to get your referral link.
                                    <br />
