...
const Home = () => {
  ...
  <div className="py-[90px]">
    ...
    <div className="sm:mt-6 mt-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      <div className="bg-white p-6 rounded-lg shadow-md text-center">
        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 640 512" className="text-4xl mx-auto text-[#f08e80] mb-4" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="bg-white p-6 rounded-lg shadow-md text-center">
        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" className="text-4xl mx-auto text-[#f08e80] mb-4" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
  ...
  <div>
    ...
    <p className="mt-4 text-lg text-center">In today's market, with interest rates above 6.5%, a typical home buyer could end up paying over $1 million in interest to a bank over the life of their mortgage. <br></br>We believe there's a better way. </p>
    ...
    <div className="sm:mt-6 mt-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      <div className="bg-white p-6 rounded-lg shadow-md text-center">
        ...
        <p className="mt-2 text-gray-600">Shifting focus away from financial institutions and towards the people who matter most - buyers and sellers.</p>
      </div>
      <div className="bg-white p-6 rounded-lg shadow-md text-center">
        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 352 512" className="text-4xl mx-auto text-[#f08e80] mb-4" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
